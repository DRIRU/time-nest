    ...
    <footer id="support" className="bg-gray-900 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">TimeNest</span>
            </Link>
            <p className="text-gray-400 mb-4">
              Building stronger communities through service exchange and time credits.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} TimeNest. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
