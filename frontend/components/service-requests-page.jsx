        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link href="/services" className="text-muted-foreground hover:text-blue-600 transition-colors">
                Browse Services
              </Link>
              <Link href="/requests" className="text-blue-600 font-medium">
                Service Requests
              </Link>
              <Link href="/#how-it-works" className="text-muted-foreground hover:text-blue-600 transition-colors">
                How It Works
              </Link>
              <Link href="/list-service" className="text-muted-foreground hover:text-blue-600 transition-colors">
                List Service
              </Link>
              <Link
                href="/#support"
