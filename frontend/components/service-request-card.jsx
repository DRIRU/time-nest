        ...
        <div className="pt-4 border-t flex items-center justify-between">
          <div className="flex items-center">
            <div className="h-8 w-8 rounded-full overflow-hidden mr-2">
              <Image
                src={request.requester.image || "/placeholder.svg?height=32&width=32&text=User"}
              ...
              <div className="flex items-center">
                <div className="flex items-center">
                  {[...Array(5)].map((_, i) => (
                    <svg
                      key={i}
                      className={`h-3 w-3 ${i < Math.floor(request.requester.rating) ? "text-yellow-400" : "text-gray-300 dark:text-gray-600"}`}
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                ...
                <span className="text-xs text-muted-foreground ml-1">{request.requester.rating}</span>
              </div>
            </div>
          </div>
